        ...
        <section>
            ...
            <div class="content" v-if="newadds">
                ...
                <div class="delet" @click="delet">ㄨ</div>
                    <el-table :data="newall_node" highlight-current-row :height="480" style="border-right:solid 1px #dfe6ec;height:300px;overflow: hidden;" @selection-change="handleSelectionChange">
                     <!-- 多选框去除 -->
                    ...
                    <el-footer class="footer-fenye">
                        ...
                        <el-col :span="24" class="toolbar-bot">
                            ...
                            <el-pagination style="cursor:pointer" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage1" :page-size="size" layout="prev, pager, next, jumper" :total="total">
                            </el-pagination>
                        </el-col>
                    </el-footer>
                </div>
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      // alert(1)
      this.vehicleId=this.jiedianid
      this.value1 =
        !this.value1 || this.value1 == ""
          ? ""
          : util.formatDate.format(new Date(this.value1), "yyyy-MM-dd hh:mm");
      this.value2 =
        !this.value2 || this.value2 == ""
          ? ""
          : util.formatDate.format(new Date(this.value2), "yyyy-MM-dd hh:mm");
