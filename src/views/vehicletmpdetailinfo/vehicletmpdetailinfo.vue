<template>
    <div style="padding:0 10px;margin-top:10px;">
        ...
        <el-table-column prop="unitName" label="仓库名称" width="120" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="nodeName" label="设备名称" width="140" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="temperatureMin" label="最低温度" min-width="95" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="temperatureMax" label="最高温度" min-width="95" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="tmp1Avg" label="平均温度" min-width="95" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="dayReport1" label="日平均温度低于阀值1的天数(d)" min-width="100" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="dayReport2" label="日平均温度高于阀值2的天数(d)" min-width="100" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="dayRepor1AndReport2" label="日平均温度低于阀值1高于阀值2的天数(d)" min-width="120" :show-overflow-tooltip="true">
        </el-table-column>
      ...
      this.$message({
        ...
        type: "warning"
          ...
          window.location.href =
            "http://114.55.138.209:8091/jygpsTmp/vehicletmpdetailinfo/excleTmpHuiZong?vehicleIds=" +
            this.value11 +
            "&starTime=" +
            that.value3 +
            "&endTime=" +
          ...
          //   inputValue.splice(inputValue.indexOf(-1),1)
          // }
          // if(inputValue.indexOf(0)!==-1){
          //   inputValue.splice(inputValue.indexOf(0),1)
          // }
          console.log(this.value11)
          this.getnum++;
                    let para = {
                      page: this.page,
                      size: this.size,
                      vehicleIds: inputValue,
                      unitId: this.select,
                      starTime: this.value3,
                      endTime: this.value4
                    };
                    // this.listLoading = true;
                    //查询的结果

                    vehicletmpdetailinfo(para).then(res => {
