          ...
          <el-row class="tac" style="height:100%;padding-top:26px;">
            <el-col :span="12">
              <el-menu :default-active="$route.path" class="el-menu-vertical-demo" background-color="#545c64"
                ...
                <el-menu-item index="/echarts" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show1">
                  <i class="">
                    <img style="width:15px;" v-if="$route.path==='/echarts'" src="../assets/icon/cang.png" alt="">
                    <img style="width:15px;" v-else src="../assets/icon/newcang.png" alt="">
                  </i>
                  <span slot="title">首页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </el-menu-item>
                <el-menu-item index="/monitor" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show2">
                  <i class="">
                ...
                <el-menu-item index="/Table" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show3">
                  <i class="">
                ...
                <el-menu-item index="/Alarmrecord" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show4">
                  <i class="">
                ...
                <el-menu-item index="/vehicletmpdetailinfo" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show5">
                  <i class="">
                    <img style="width:15px;" v-if="$route.path==='/vehicletmpdetailinfo'" src="../assets/icon/newcangku.png" alt="">
                    <img style="width:15px;" v-else src="../assets/icon/cangku.png" alt="">
                  </i>
                  <span slot="title">仓库温度报表</span>
                </el-menu-item>
                <el-menu-item index="/equipment" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show6">
                  <i class="">
                ...
                <el-menu-item index="/Userlist" style="vertical-align: middle;text-align:center;margin-left:-8px;" v-if="show7">
                  <i class="">
...
export default {
 ...
 created:function(){
  ...
  this.info=info
  // 控制左侧栏类别权限显隐
  let length=this.info.menu.length
  let that=this
  for(var i=0;i<length;i++){
    if(this.info.menu[i].menu_name=='首页'){
        that.show1=true
    }
    if(this.info.menu[i].menu_name=='监控中心'){
        that.show2=true
    }
    if(this.info.menu[i].menu_name=='历史查询'){
        that.show3=true
    }
    if(this.info.menu[i].menu_name=='报警记录'){
        that.show4=true
    }
    if(this.info.menu[i].menu_name=='仓库温度报表'){
        that.show5=true
    }
    if(this.info.menu[i].menu_name=='设备管理'){
        that.show6=true
    }
    if(this.info.menu[i].menu_name=='用户列表'){
        that.show7=true
    }
  }
