...
export const company = params => { return instance.post(`${base}/getUnitTree`, qs.stringify( params )).then(res => res.data); };
export const companysave = params => { return instance.post(`${base}/sysunitinfo/save`, qs.stringify( params )).then(res => res.data); };
export const companydelet = params => { return instance.post(`${base}/sysunitinfo/delete`, qs.stringify( params )).then(res => res.data); };
